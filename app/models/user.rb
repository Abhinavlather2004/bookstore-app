class User < ApplicationRecord
  ...
  validates :email, format: { with: VALID_EMAIL_DOMAINS, message: "must be from a valid domain (e.g., gmail.com, yahoo.com)" }
  ...
  validates :mobile_number, format: { with: /\A[6-9]\d{9}\z/, message: "must be a 10-digit number starting with 6, 7, 8, or 9" }
